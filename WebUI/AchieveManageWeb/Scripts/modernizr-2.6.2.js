...
window.Modernizr = (function( window, document, undefined ) {
     ...
     */
    mod = 'modernizr',
    AchieveEntity.m = document.createElement(mod),
    mStyle = AchieveEntity.m.style,
    ...
    // Reset AchieveEntity.m.cssText to nothing to reduce memory footprint.
    setCss('');
    AchieveEntity.m = inputElem = null;
